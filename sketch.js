...
// - NEW: Added "Bật/Tắt quay electron" button to toggle electron rotation.
// - UPDATED: Tăng tốc độ quay của electron.
// - NEW FEATURE: Added flickering cylinder connecting the two nuclei when the sphere overlay is active.
// - UPDATED FEATURE: Cylinder now only appears after electron transfer, has its axis on the line connecting the two nuclei, and has its diameter tripled.
// - REVISED: The cylinder's axis is now properly aligned with the line connecting the two nuclei, as requested.
// - FINAL REVISION: Cylinder diameter doubled again and flicker effect is made more observable.
// - LATEST REVISION: Cylinder diameter slightly increased once more.
...
    fill(255, 255, 255, 40); // White with 40 alpha (very faint)
...
                                    let dynamicSpeed = lerp(0.03, 0.01, moveProgress);
